...
\begin{frame}[fragile]{Ramificación}
    \begin{columns}[T,onlytextwidth]
      ...
      \column{0.48\textwidth}
        \begin{figure}
          \only<1>{\scalebox{.95}{\input{gitdags/branch}}}
          \only<2>{\scalebox{.95}{\input{gitdags/branch2}}}
          \only<3>{\scalebox{.95}{\input{gitdags/branch3}}}
          \only<4>{\scalebox{.95}{\input{gitdags/branch4}}}
          \only<5>{\scalebox{.95}{\input{gitdags/branch5}}}
          \only<6>{\scalebox{.95}{\input{gitdags/branch6}}}
        \end{figure}
    \end{columns}
\end{frame}
